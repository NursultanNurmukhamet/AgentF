...
from agent_base_nova import create_hybrid_invoke_handler
...
fast_path_commands = build_fast_path(POSITION_LABEL, full=False)


# --- Wire it up ---

create_hybrid_invoke_handler(
    app, SYSTEM_PROMPT, MY_PLAYER_ID, POSITION_LABEL, fallback_commands,
    fallback_cfg=FWD1_CONFIG, fast_path_fn=fast_path_commands,
)
